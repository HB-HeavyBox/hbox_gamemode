...
[Library( "ent_car_tesla", Title = "Tesla", Spawnable = true )]
public partial class TeslaEntity : Prop, IUse
{
	[ConVar.Replicated( "debug_car" )]
	public static bool debug_car { get; set; } = false;

	private TeslaWheel frontLeft;
	private TeslaWheel frontRight;
	private TeslaWheel backLeft;
	private TeslaWheel backRight;
	...
	public TeslaEntity()
	{
		frontLeft = new TeslaWheel( this );
		frontRight = new TeslaWheel( this );
		backLeft = new TeslaWheel( this );
		backRight = new TeslaWheel( this );
	}
	...
	public override void Spawn()
	{
		...
		var modelName = "models/heavybox/cars/teslaS/tesla_model_s";
	...
	public override void ClientSpawn()
	{
...

		{
			...
			chassis_axle_front.LocalPosition = new Vector3( 1.80f, 0, 0.40f ) * 40.0f;
			clientModels.Add( chassis_axle_front );

			{
				wheel0 = new ModelEntity();
				wheel0.SetModel( "models/heavybox/cars/teslaS/tesla_model_s_wheel" );
...

			{
				...
				wheel1.SetModel( "models/heavybox/cars/teslaS/tesla_model_s_wheel" );
...

		{
			...
			chassis_axle_rear.LocalPosition = new Vector3( -2.20f, 0, 0.50f ) * 40.0f;
...

			{
				...
				wheel2.SetModel( "models/heavybox/cars/teslaS/tesla_model_s_wheel" );
...

			{
				...
				wheel3.SetModel( "models/heavybox/cars/teslaS/tesla_model_s_wheel" );
	...
	public bool OnUse( Entity user )
	{
		...
		{
			player.Vehicle = this;
			player.VehicleController = new TeslaController();
			player.VehicleCamera = new TeslaCamera();
